          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 md:mb-12">
              <div className="inline-flex items-center gap-2 bg-[#2D5F3F]/10 text-[#2D5F3F] px-4 py-2 rounded-full mb-4">
                ...
                <span className="text-xs sm:text-sm font-semibold">Post-Treatment Care</span>
              </div>
              ...
              {aftercareContent.resultsDescription && (
                <p className="text-sm md:text-base text-[#6B7280] max-w-3xl mx-auto leading-relaxed">
                  {aftercareContent.resultsDescription}
                </p>
              )}
            </div>
              ...
              {aftercareContent.resultPoints?.map((point, index) => (
                <div key={index} className="group bg-white rounded-2xl p-6 shadow-sm border border-[#E5E7EB] hover:border-[#2D5F3F]/40 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#2D5F3F] to-[#3A7B51] rounded-xl flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-sm sm:text-base font-semibold text-[#1F2937] leading-snug group-hover:text-[#2D5F3F] transition-colors duration-300">
                        {point}
                      </h3>
                    </div>
                  </div>
            ...
            {aftercareContent.additionalInfo && (
              <div className="relative overflow-hidden bg-gradient-to-r from-[#2D5F3F] to-[#3A7B51] rounded-2xl p-6 md:p-8 text-white shadow-2xl">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg md:text-xl font-bold">{aftercareContent.additionalInfo.title}</h3>
                  </div>
        ...
        <section id="why-choose-ramacare" className="w-full bg-white py-12 md:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 md:mb-16">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#2D5F3F]/10 to-[#3A7B51]/10 text-[#2D5F3F] px-4 py-2 rounded-full mb-6 shadow-sm">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span className="text-xs sm:text-sm font-semibold tracking-wide uppercase">Why Choose Us</span>
              </div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#1F2937] mb-6 leading-tight">
                {whyChooseContent.title}
              </h2>
              {whyChooseContent.intro && (
                <p className="text-sm md:text-base text-[#6B7280] max-w-4xl mx-auto leading-relaxed">
                  {whyChooseContent.intro}
                </p>
              )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
              {whyChooseContent.features.map((feature, index) => {
                const featureIcons = [
                  ...
                  <svg key={6} className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0a9 9 0 0118 0z" /></svg>,
                ...
                return (
                  <div key={feature.id} className="group relative bg-gradient-to-br from-white to-[#F9FAFB] rounded-2xl p-6 shadow-sm border border-[#E5E7EB] hover:border-[#2D5F3F]/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <div className="w-12 h-12 bg-gradient-to-br from-[#2D5F3F] to-[#3A7B51] rounded-xl flex items-center justify-center text-white mb-4 shadow-md group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                        {featureIcons[index] || featureIcons[0]}
                      </div>
                      <div className="absolute top-4 right-4 text-3xl font-bold text-[#E5E7EB] group-hover:text-[#2D5F3F]/10 transition-colors duration-500">
                        {String(index + 1).padStart(2, '0')}
                      </div>
                      <h3 className="text-sm sm:text-base font-bold text-[#1F2937] mb-2 group-hover:text-[#2D5F3F] transition-colors duration-500 leading-snug">
                        {feature.title}
                      </h3>
                      {feature.description && (
                        <p className="text-xs sm:text-sm text-[#6B7280] leading-relaxed group-hover:text-[#4B5563] transition-colors duration-500">
                          {feature.description}
                        </p>
                      )}
                    </div>
            ...
            <div className="mt-12 md:mt-16 text-center">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#F8FAFC] to-[#F1F5F9] rounded-2xl px-6 py-4 shadow-sm border border-[#E5E7EB]">
                <div className="flex -space-x-2">
                  <div className="w-8 h-8 bg-gradient-to-br from-[#2D5F3F] to-[#3A7B51] rounded-full flex items-center justify-center text-white text-xs font-bold border-2 border-white">✓</div>
                  <div className="w-8 h-8 bg-gradient-to-br from-[#3A7B51] to-[#407D54] rounded-full flex items-center justify-center text-white text-xs font-bold border-2 border-white">✓</div>
