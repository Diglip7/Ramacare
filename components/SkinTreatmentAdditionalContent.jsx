    ...
    <div>
      ...
      {risksAndSafety && (
        <section id="risks-and-safety" className="w-full py-12 md:py-16 bg-gradient-to-b from-[#F9FAFB] to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-6 md:p-8 border border-[#E5E7EB]">
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6">
                {risksAndSafety.points.map((point, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <div className="w-7 h-7 rounded-full bg-[#2D5F3F] flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <span className="text-sm sm:text-base text-[#111827] font-medium">{point}</span>
                  </li>
                ))}
              </ul>
              <div className="mt-8 p-5 bg-gradient-to-r from-[#2D5F3F] to-[#3A7B51] rounded-2xl text-white text-center">
                <p className="text-sm md:text-base">{risksAndSafety.closing}</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#E5E7EB]">
                <div className="mb-6">
                  <span className="inline-block bg-[#E8E3D8] text-[#2D5F3F] px-4 py-1.5 rounded-full text-xs sm:text-sm font-semibold mb-4">Why Choose Us</span>
              ...
              <div className="bg-gradient-to-br from-[#2D5F3F]/5 to-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#2D5F3F]/20">
                <h3 className="text-lg md:text-xl font-bold text-[#2D5F3F] mb-4">What You Can Expect</h3>
                <ul className="space-y-4">
                  {whyChooseSection.features.map((feature) => (
                    <li key={feature.id} className="flex items-start gap-3.5">
                      <div className="flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9 bg-[#2D5F3F] rounded-full flex items-center justify-center mt-0.5">
                        <svg
                      ...
                      <div>
                        <p className="text-[#111827] font-semibold text-sm sm:text-base">{feature.title}</p>
                        {feature.description && (
                          <p className="text-[#6B7280] text-xs sm:text-sm mt-1">{feature.description}</p>
                        )}
                      </div>
                    </li>
                  ))}
        ...
        <section id="professional-benefits" className="w-full py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 md:mb-16">
              <span className="inline-block bg-[#E8E3D8] text-[#2D5F3F] px-4 py-1.5 rounded-full text-xs sm:text-sm font-semibold mb-4">Why Professional Care</span>
              <h2 className="text-2xl md:text-3xl font-bold text-[#111827] leading-tight mb-6">
                {professionalBenefits.title}
              </h2>
              <p className="text-sm md:text-base text-[#6B7280] max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {professionalBenefits.points.map((point) => (
                ...
                >
                  ...
                  <p className="text-[#6B7280] text-xs sm:text-sm leading-relaxed">{point.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="when-to-consider" className="w-full py-12 md:py-16 bg-gradient-to-b from-[#F9FAFB] to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-6 md:p-8 border border-[#E5E7EB]">
              ...
              <div className="mt-8 p-5 bg-gradient-to-r from-[#2D5F3F] to-[#3A7B51] rounded-2xl text-white text-center">
                <p className="text-sm md:text-base">{whenToConsider.closing}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="choosing-right-approach" className="w-full py-12 md:py-16 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-gradient-to-br from-[#F9FAFB] to-white rounded-2xl p-6 md:p-8 shadow-lg border border-[#E5E7EB]">
              <div className="text-sm md:text-base text-[#6B7280] leading-relaxed mb-6 space-y-4" dangerouslySetInnerHTML={{ __html: choosingRightApproach.content }}></div>
              <style>{`
              ...
              `}</style>
              <div className="p-5 bg-[#ECFDF5] rounded-xl border-l-4 border-[#2D5F3F]">
                <p className="text-[#2D5F3F] font-semibold text-sm md:text-base">{choosingRightApproach.closing}</p>
              </div>
            </div>
          </div>
        </section>
      ...
      {skinConditions && (
        <section id="skin-conditions" className="w-full py-12 md:py-16 bg-gradient-to-b from-white to-[#F9FAFB]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 md:mb-16">
              <span className="inline-block bg-[#E8E3D8] text-[#2D5F3F] px-4 py-1.5 rounded-full text-xs sm:text-sm font-semibold mb-4">Conditions We Treat</span>
              <h2 className="text-2xl md:text-3xl font-bold text-[#111827] leading-tight mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
              {skinConditions.conditions.map((condition) => (
                ...
                >
                  <h3 className="text-lg md:text-xl font-bold text-[#2D5F3F] mb-3">{condition.title}</h3>
                  <p className="text-[#6B7280] text-xs sm:text-sm leading-relaxed mb-4">{condition.description}</p>
                  <h4 className="text-xs sm:text-sm font-semibold text-[#111827] mb-2.5">Common Concerns:</h4>
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {condition.commonConcerns.map((concern, index) => (
                      <li key={index} className="flex items-start gap-2">
                        ...
                        <span className="text-[#4B5563] text-xs sm:text-sm">{concern}</span>
                      </li>
                    ))}
                  </ul>
                </div>
            ...
            {skinConditions.earlyTreatment && (
              <div className="mt-10 bg-gradient-to-r from-[#2D5F3F] to-[#3A7B51] rounded-2xl p-6 md:p-8 text-white shadow-xl">
                <h3 className="text-lg md:text-xl font-bold mb-3">{skinConditions.earlyTreatment.title}</h3>
                <p className="text-sm md:text-base leading-relaxed">{skinConditions.earlyTreatment.description}</p>
              </div>
            )}
          </div>
        </section>
