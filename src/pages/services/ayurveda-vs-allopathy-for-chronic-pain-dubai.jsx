...
const SEO = {
  ...
  canonical: 'https://ramacarepolyclinic.ae/ayurveda-vs-allopathy-for-chronic-pain-dubai',
};
...
const CONDITIONS = [
  { icon: Bone, name: 'Arthritis Treatment Dubai', approach: 'Allopathy (NSAIDs, injections) often controls acute inflammation, while Ayurveda and physiotherapy support long-term joint mobility.' },
  { icon: Activity, name: 'Back Pain Treatment Dubai', approach: 'Physiotherapy and Ayurvedic therapies work well for chronic, non-structural back pain; allopathic imaging is important to rule out disc involvement first.' },
  { icon: Stethoscope, name: 'Neck Pain Treatment Dubai', approach: 'Often responds well to manual therapy, physiotherapy, and Ayurvedic oil-based treatments once serious structural causes are excluded.' },
  { icon: Zap, name: 'Sciatica Treatment Dubai', approach: 'Requires accurate diagnosis (often via MRI); mild to moderate cases often respond to physiotherapy and Ayurvedic management, while severe nerve compression may need allopathic or surgical intervention.' },
  { icon: HeartPulse, name: 'Frozen Shoulder Treatment Dubai', approach: 'A combination of physiotherapy, dry needling, and Ayurvedic therapy is common; allopathic injections can help in resistant cases.' },
  { icon: ScanLine, name: 'Slip Disc Treatment Dubai', approach: 'Requires allopathic diagnostic imaging; conservative management is usually tried first, with surgery reserved for severe cases.' },
  { icon: Bone, name: 'Joint Pain Treatment Dubai', approach: 'Best managed with anti-inflammatory care, physiotherapy, and lifestyle-based Ayurvedic support.' },
  { icon: Brain, name: 'Migraine Treatment Dubai', approach: 'Both stress-reduction-focused Ayurvedic therapies and allopathic preventive medication have roles, depending on frequency and severity.' },
  { icon: Activity, name: 'Sports Injury Rehabilitation Dubai', approach: 'Typically allopathy-led in the acute phase, followed by physiotherapy-based rehabilitation.' },
];
...
const LINK_GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Migraine Treatment Dubai', href: '/services/migraine-treatment-dubai' },
      ...
      { label: 'Insomnia Treatment Dubai', href: '/services/insomnia-treatment-dubai' },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Book Appointment Page', href: '#book-now' },
      { label: 'Doctor Profile Pages', href: '/doctors' },
    ],
  },
];
  ...
  return (
    <Layout>
      ...
      <div className="bg-white text-[#1A1A1A] antialiased">
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
              <div className="lg:col-span-7">
                ...
                <p className="mt-5 max-w-xl text-lg leading-relaxed text-[#5F5F5F]">
                ...
                <p className="mt-4 max-w-xl text-base leading-relaxed text-[#5F5F5F]">
                  Chronic back pain, knee osteoarthritis, cervical spondylosis, frozen shoulder,
                  and sciatica are among the most common reasons people in Dubai search for both
          ...
          <div className="space-y-20">
              ...
              <section id="why-compare" className="scroll-mt-24">
                ...
                <div className="mt-6">
                  <p className="text-base leading-relaxed text-[#5F5F5F]">
                    ...
                    access is exactly why so many patients now search for Ayurveda Treatment Dubai
                    and Allopathy Treatment Dubai side by side before committing to a plan.
                  </p>
                  <p className="mt-3 text-base font-semibold text-[#1A1A1A]">A few reasons this comparison has become so common:</p>
                  <ul className="mt-3 space-y-2.5">
                    {WHY_COMPARE.map((w) => (
                      <li key={w} className="flex items-start gap-2.5 text-base leading-relaxed text-[#1A1A1A]">
              ...
              <section id="what-is-ayurveda" className="scroll-mt-24 grid gap-8 sm:grid-cols-12">
                ...
                <div className="order-1 sm:order-2 sm:col-span-7">
                  ...
                  <p className="mt-3 text-base font-semibold text-[#1A1A1A]">Core Elements of Ayurvedic Pain Treatment</p>
                  <div className="mt-4 space-y-4">
                    {AYURVEDA_ELEMENTS.map((e) => {
                      const Icon = e.icon;
                      return (
                        <div key={e.name} className="flex items-start gap-3 rounded-xl p-3 transition-colors hover:bg-[#D4A574]/5">
                          <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-[#D4A574]/15 text-[#8A6A3F]">
                            <Icon className="h-4 w-4" />
                          </div>
                          <div>
                            <p className="text-base font-semibold text-[#1A1A1A]">{e.name}</p>
                            <p className="text-base leading-relaxed text-[#5F5F5F]">{e.desc}</p>
                          </div>
                        </div>
                      );
                    })}
              ...
              <section id="what-is-allopathy" className="scroll-mt-24 grid gap-8 sm:grid-cols-12">
                <div className="sm:col-span-7">
                  ...
                  <p className="mt-3 text-base font-semibold text-[#1A1A1A]">Core Elements of Allopathic Pain Treatment</p>
                  <div className="mt-4 space-y-4">
                    {ALLOPATHY_ELEMENTS.map((e) => {
                      const Icon = e.icon;
                      return (
                        <div key={e.name} className="flex items-start gap-3 rounded-xl p-3 transition-colors hover:bg-[#1F5E4B]/5">
                  ...
                  <table className="w-full min-w-[640px] border-collapse text-left text-base">
                    <thead>
                      <tr className="border-b border-gray-100">
                        <th className="px-5 py-3 font-semibold text-[#1A1A1A]">Criteria</th>
                        <th className="px-5 py-3 font-semibold text-[#8A6A3F]">Ayurveda</th>
                        <th className="px-5 py-3 font-semibold text-[#1F5E4B]">Allopathy</th>
                      </tr>
                    </thead>
                    <tbody>
                      {COMPARISON.map((row, i) => (
                        <tr key={row.criteria} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F9F7F2]/60'}>
                          <td className="px-5 py-3 font-medium text-[#1A1A1A]">{row.criteria}</td>
                          <td className="px-5 py-3 text-[#5F5F5F]">{row.ayurveda}</td>
                          <td className="px-5 py-3 text-[#5F5F5F]">{row.allopathy}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                </div>
                <p className="mt-5 text-base leading-relaxed text-[#5F5F5F]">
                  Ayurveda Treatment Dubai tends to appeal to patients managing long-standing,
              ...
              <section id="combined" className="scroll-mt-24 grid gap-8 sm:grid-cols-12">
                ...
                <div className="order-1 sm:order-2 sm:col-span-7">
                  ...
                  <p className="mt-3 text-base leading-relaxed text-[#5F5F5F]">
                    ...
                    to control an acute flare-up, while introducing physiotherapy, Ayurvedic
                    Panchakarma, or manual therapy to address underlying mobility, posture, and
                    lifestyle factors once the acute phase settles. Some patients also use Ayurveda
                    alongside ongoing physiotherapy and dry needling to manage chronic stiffness
              ...
              <section id="conditions" className="scroll-mt-24">
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {CONDITIONS.map((c) => {
                    const Icon = c.icon;
                    return (
                      <div key={c.name} className="rounded-2xl border border-gray-100 p-5 transition-all hover:-translate-y-0.5 hover:shadow-md">
                        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#1F5E4B]/10 text-[#1F5E4B]">
                          <Icon className="h-4 w-4" />
                        </div>
                        <p className="mt-3 text-base font-semibold text-[#1A1A1A]">{c.name}</p>
                        <p className="mt-1.5 text-base leading-relaxed text-[#5F5F5F]">{c.approach}</p>
                      </div>
                    );
                  })}
                </div>
              ...
              {/* ---- 11. Why choose us: stat left / list right ---- */}
              <section id="why-us" className="scroll-mt-24 rounded-2xl bg-[#F9F7F2] p-6 sm:p-8">
                <div className="grid gap-8 sm:grid-cols-12">
                  <div className="sm:col-span-4">
                    ...
                    <p className="text-base leading-relaxed text-[#5F5F5F]">
                      ...
                      Dubai, offering Physiotherapy Dubai and Ayurveda Treatment Dubai under one
                      ...
                      healthcare professionals across both disciplines and receive an
                  ...
                  <div className="sm:col-span-8">
                    <div className="grid gap-3 sm:grid-cols-2">
                      {WHY_US.map((w) => (
                        <div key={w} className="flex items-start gap-2.5 rounded-xl bg-white p-4 text-base leading-relaxed text-[#1A1A1A]">
              ...
              <section id="faq" className="scroll-mt-24">
                ...
                <div className="columns-1 gap-5 sm:columns-2">
                  {FAQS.map((f, idx) => {
                    ...
                    return (
                      <div key={f.q} className="mb-4 break-inside-avoid overflow-hidden rounded-xl border border-gray-100">
                        <button
                          onClick={() => setOpenFaq(isOpen ? -1 : idx)}
                          className="flex w-full items-center gap-3 px-4 py-3.5 text-left"
                        >
                          <span className="flex-1 text-base font-semibold text-[#1A1A1A]">{f.q}</span>
                        ...
                        <AnimatePresence initial={false}>
                          {isOpen && (
                            ...
                            >
                              <p className="border-t border-gray-100 px-4 pb-4 pt-3 text-base leading-relaxed text-[#5F5F5F]">{f.a}</p>
                            </motion.div>
                          )}
                        </AnimatePresence>
                      </div>
        ...
        <section className="px-4 py-16">
          <div className="mx-auto max-w-6xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="mt-3 text-base leading-relaxed text-[#5F5F5F]">
                A closer look at the specific services, conditions, and guides mentioned throughout this comparison.
              </p>
            </div>
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-2">
              {LINK_GROUPS.map((g) => {
                ...
                return (
                  <div
                    key={g.title}
                    className="flex flex-col rounded-2xl border border-gray-100 bg-white p-6 transition-all hover:-translate-y-0.5 hover:shadow-md"
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2 flex-1">
                      {g.links.map((l) => (
                        <a
                          key={l.href}
                          href={l.href}
                          className="flex items-center gap-2 rounded-lg border border-gray-100 bg-[#F9F7F2] px-4 py-3 text-xs font-medium text-[#1A1A1A] transition-colors hover:border-transparent hover:text-white"
        ...
        <section id="book-now" className="px-4 py-16">
          <div className="mx-auto max-w-6xl rounded-2xl border border-gray-100 p-8 sm:p-10">
            <div className="grid gap-8 sm:grid-cols-12">
              <div className="sm:col-span-7">
                <p className="text-base leading-relaxed text-[#5F5F5F]">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#1F5E4B] px-6 py-3 text-base font-semibold text-white hover:bg-[#17493B]"
                  >
              ...
              <div className="sm:col-span-5">
                <div className="rounded-xl bg-[#F9F7F2] p-5">
                  <p className="text-base font-semibold text-[#1A1A1A]">Medical Disclaimer</p>
                  <p className="mt-2 text-base italic leading-relaxed text-[#5F5F5F]">
