                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className={`contact-form-input w-full pl-12 pr-4 py-3 border rounded-xl focus:ring-2 transition-all bg-white text-gray-900 placeholder-gray-500 ${errors.fullName ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-[#1a5f3f]'
                            }`}
                        />
                      </div>
                      {errors.fullName && (
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className={`contact-form-input w-full pl-12 pr-4 py-3 border rounded-xl focus:ring-2 transition-all bg-white text-gray-900 placeholder-gray-500 ${errors.phone ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-[#1a5f3f]'
                            }`}
                        />
                      </div>
                      {errors.phone && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className={`contact-form-input w-full pl-12 pr-4 py-3 border rounded-xl focus:ring-2 transition-all bg-white text-gray-900 placeholder-gray-500 ${errors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-[#1a5f3f]'
                          }`}
                      />
                    </div>
                    {errors.email && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className={`contact-form-input w-full pl-12 pr-4 py-3 border rounded-xl focus:ring-2 transition-all bg-white text-gray-900 ${errors.subject ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-[#1a5f3f]'
                          }`}
                      >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        required
                        className={`contact-form-input w-full pl-12 pr-4 py-3 border rounded-xl focus:ring-2 transition-all resize-none bg-white text-gray-900 placeholder-gray-500 ${errors.message ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-[#1a5f3f]'
                          }`}
                      />
                    </div>
                    {errors.message && (
